 ...
 *
 * Отдельно — `learn.php` добавляет обезличенные события в очередь, а
 * `feedback.php` пишет агрегированную A/B-статистику — без rate limit это
 * стало бы дешёвым вектором спама. Ни один из этих запросов не меняет
 * production-веса модели.
 *
