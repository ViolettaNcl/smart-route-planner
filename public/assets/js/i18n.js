...
const I18N = {
    ru: {
        ...
        mapPlaceholderTitle: 'Ваш маршрут оживёт здесь',
        ...
        mapIdentityTitle: 'Eco terrain',
        mapIdentitySubtitle: 'OpenFreeMap · без API-ключа',
        mapPill2d: 'Чистая 2D',
        mapPill3d: 'Рельефная 3D',
        mapPillKeyless: 'Без ключа',
        mapStaticMode: 'Облегчённая карта маршрута — интерактивный 3D-режим недоступен на этом устройстве.',
        ...
        highlightMapTitle: 'Живая 2D/3D-карта',
        highlightMapText: 'Рельеф, здания и природные цвета — без API-ключа',
    },
    en: {
        pageTitle: 'Smart Route Planner',
        heading: 'Smart Route Planner',
        ...
        mapIdentityTitle: 'Eco terrain',
        mapIdentitySubtitle: 'OpenFreeMap · no API key',
        mapPill2d: 'Clean 2D',
        mapPill3d: 'Terrain 3D',
        mapPillKeyless: 'Keyless',
        mapStaticMode: 'Lightweight route map — interactive 3D is unavailable on this device.',
        ...
        highlightMapTitle: 'Living 2D/3D map',
        highlightMapText: 'Terrain, buildings, and nature colors — with no API key',
    },
};
